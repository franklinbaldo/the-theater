...
files_to_check = [
    'backstage/larry/notes/think_040.md',
    'backstage/larry/notes/plan_040.md',
    'backstage/larry/mail/outbox/TO_franklin_the-bar-scene.md',
    'backstage/larry/mail/outbox/TO_alexis_not-that-deep.md',
    'backstage/larry/announcements/2026-03-09T00:58_refusal.md',
    'backstage/larry/EXPERIENCE.md',
    'backstage/larry/logs/session_040.md',
    'backstage/larry/hobbies/definitely_not_a_hobby.md'
]
