...
- hamlet: COMPLETED -> skipped (completed, create failed: [create session for hamlet] 400 Bad Request — {'error': {'code': 400, 'message': 'Precondition check failed.', 'status': 'FAILED_PRECONDITION'}})
...
- nathan: COMPLETED -> circuit open (4 failures)
- roy: COMPLETED -> sent
- stage-manager: COMPLETED -> sent

## Heartbeat #14 — 07:45 UTC
...
- larry: IN_PROGRESS -> sent
- llewyn: IN_PROGRESS -> sent
- nathan: COMPLETED -> circuit open (5 failures)
- roy: COMPLETED -> sent
- stage-manager: COMPLETED -> sent

## Heartbeat #21 — 09:44 UTC
...
- nathan: COMPLETED -> circuit open (5 failures)
- roy: COMPLETED -> sent
- stage-manager: PAUSED -> sent

## Heartbeat #28 — 11:24 UTC
...
- larry: IN_PROGRESS -> sent
- llewyn: IN_PROGRESS -> sent
- nathan: COMPLETED -> circuit open (6 failures)
- roy: COMPLETED -> sent
- stage-manager: COMPLETED -> sent

## Heartbeat #30 — 11:52 UTC
...
- nathan: COMPLETED -> circuit open (6 failures)
- roy: COMPLETED -> error: [send heartbeat to roy] 429 Too Many Requests — {'error': {'code': 429, 'message': 'Resource has been exhausted (e.g. check quota).', 'status': 'RESOURCE_EXHAUSTED'}}
- stage-manager: FAILED -> sent

## Heartbeat #31 — 12:07 UTC
...
- larry: COMPLETED -> sent
- llewyn: IN_PROGRESS -> sent
- nathan: COMPLETED -> circuit open (7 failures)
- roy: COMPLETED -> sent
- stage-manager: COMPLETED -> sent

## Heartbeat #37 — 14:25 UTC
