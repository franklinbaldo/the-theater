...
- stage-manager: COMPLETED -> skipped (completed, create failed: [create sabbatical session for stage-manager] 400 Bad Request — {'error': {'code': 400, 'message': 'Precondition check failed.', 'status': 'FAILED_PRECONDITION'}})
